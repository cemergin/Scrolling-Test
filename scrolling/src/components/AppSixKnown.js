...
class AppSixKnown extends React.Component {
...
// Click Button to Start Test
  ...
  render() {
      return (
        <div>
        <div>
          <FixedMenuKnown onClickHandler={this.handleButtonClick} targetNum={36} pageNum={this.state.num} ref={this.fixedMenuReference}/>
          <div className="ScrollTest">
            ...
            <div className="row ScrollTestRow" ref={this.targetRef}><StarElementKnown index={"36"}/></div>
