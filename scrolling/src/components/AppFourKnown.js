...
class AppFourKnown extends React.Component {
...
// Click Button to Start Test
  ...
  render() {
      return (
        <div>
        <div>
          <FixedMenuKnown onClickHandler={this.handleButtonClick} targetNum={45} pageNum={this.state.num} ref={this.fixedMenuReference}/>
          <div className="ScrollTest">
            ...
            <div className="row ScrollTestRow" ref={this.targetRef}><StarElementKnown index={"45"}/></div>
